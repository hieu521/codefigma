    ...
    <>
      <header className="bg-[#000000]/70 max-lg:bg-[#000000] h-[111px] flex items-center w-full lg:fixed z-20 justify-evenly">
        ...
        <div className="lg:hidden">
          ...
          >
            <Image src="/hamberger.png" alt="Menu" width={80} height={30} />
          </button>
        </div>
        ...
        <nav className="hidden lg:flex items-center">
          <a
            href="#"
            className="text-[30px] text-white font-bold cursor-pointer hover:opacity-80 mr-8" // Adjust margin here
          >
            About us
          </a>
          <a
          ...
          <a
            href="#"
            className="text-[30px] text-white font-bold cursor-pointer hover:opacity-80 mr-12" // Add margin here to create space
          >
            Quick Withdrawal
          </a>
        </nav>
